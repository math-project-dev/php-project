...
<body>
	...
	<main>
		...
		<?
			for($i = 1; $i <= 12; $i++)
			{ ?>
				<img src="images/0<?=$i?>_01.png" style="padding: 5px;">
			<? } 
		...
		<?
			for($i = 1; $i <= 4; $i++)
			{ ?>
				<img src="images/0<?=$i?>_02.png" style="padding: 5px;">
			<? } 
		} else if($sector == 3) {
		?>
			<div class="positionTasks">На этой странице представлены справочные материалы,<br> взятые из официальной демоверсии ЕГЭ по математике базового уровня</div>
		<?
			for($i = 1; $i <= 4; $i++)
			{ ?>
				<img src="images/0<?=$i?>_03.png" style="padding: 5px;">
			<? } 
		} else if($sector == 4) {
		?>
			<div class="positionTasks">На этой странице представлены справочные материалы,<br> взятые из официальной демоверсии ЕГЭ по математике базового уровня</div>
		<?
			for($i = 1; $i <= 4; $i++)
			{ ?>
				<img src="images/0<?=$i?>_04.png" style="padding: 5px;">
			<? } 
		} else if($sector == 5) {
		?>
			<div class="positionTasks">На этой странице представлены справочные материалы,<br> взятые из официальной демоверсии ЕГЭ по математике базового уровня</div>
		<?
			for($i = 1; $i <= 4; $i++)
			{ ?>
				<img src="images/0<?=$i?>_05.png" style="padding: 5px;">
			<? } 
		} else if($sector == 6) {
		?>
			<div class="positionTasks">На этой странице представлены справочные материалы,<br> взятые из официальной демоверсии ЕГЭ по математике базового уровня</div>
		<?
			for($i = 1; $i <= 4; $i++)
			{ ?>
				<img src="images/0<?=$i?>_06.png" style="padding: 5px;">
			<? } 
		} ?>
		</div>
	</main>
